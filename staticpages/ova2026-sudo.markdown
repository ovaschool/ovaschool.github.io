---
layout: page
title: Yasutada Sudo - Focus
permalink: ova2026-sudo
exclude: true
---
...
In this course, we will first review Rooth's Alternative Semantics (Rooth 1985, 1992), which is taken to be the standard framework for the syntax-semantics-pragmatics of focus, and discuss some known issues and possible amendments to it. Then, we will closely examine some specific focus-sensitive operators as case studies.

The ultimate goal of the course is to bring you up to speed on the theory of focus, and ideally, have you find a specific linguistic phenomenon or phenomena in a language that you know to apply the knowledge to. I will try to highlight some concrete open issues that one could work on.
