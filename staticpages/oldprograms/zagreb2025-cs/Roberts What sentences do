---
title: Tom Roberts: What sentences do
permalink: /robertssentences/
layout: page
exclude: true
---
...
However, the link from semantics to discourse function is much messier than that picture may suggest. Some sentences have declarative syntax but seem to ask questions (You have a pet wombat?), other have interrogative syntax but don’t ask genuine questions (Is the Pope Catholic?), and other sentences mix sentence types in one package (Stop making noise or I’ll call the cops!). So what is the right semantics for sentences, and what factors determine how these sentences are interpreted in context? This course will explore some historical and current issues in the mapping between sentence meaning and speech acts, focusing in particular on cases where a neat mapping seems to break down, including topics like rising declaratives, rhetorical questions, tag questions, and mixed-type conjuncitons.<br/>
