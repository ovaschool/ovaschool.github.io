---
title: Veno Volenec: Introduction to formal generative phonology
permalink: /Volenec25intro/
layout: page
exclude: true
---

**Veno Volenec – Introduction to formal generative phonology**<br/>

Slides (complete): [here](https://drive.google.com/file/d/1mZhKePQ6MbXZiwqayG_dVvpYMkPraWni/view)<br/> 

This course is an introduction to phonology from the perspective of formal generative theory. Explored topics include the definition and core properties of I-language (linguistic competence), mental grammar and its components, levels of phonological representation (underlying, intermediate, surface), the organization of phonological derivation, phonemes and allophones, logical procedures that can be used to determine underlying representations from observable data, the definition of rules and natural classes, and the typology of segmental alternations.<br/>
