---
layout: page
title: OVA 2026 practical information
permalink: ova2026-location
exclude: true
---
...
The dorm rooms host up to 4 people each, with shared bathrooms per floor. The dorms are mixed-gender in general, but individual rooms will be assigned as single-gender unless otherwise specified in the registration form. 

There are pillows and beddings at the dorms but no (!) towels. Each room has its own fridge. Also, there is a kitchen but it is not equipped with utensils (like pots, plates, cutlery, etc.), please bring your own equipment for cooking and share with others. There is a washing machine (but most likely you have to bring your own washing powder).
